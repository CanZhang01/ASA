...
Accepted by Journal of Electronic Imaging (JEI).
...
2) We propose an ASA module. Its similarity matrix is obtained via two designed blocks: NLSCB and LSCB. The former utilizes A-RNN to sparsify non-local information, whereas the latter sparsifies local information with adaptive thresholds.
...
## Usage
Please refer to [MMsegmentation](https://github.com/open-mmlab/mmsegmentation/tree/main/docs/zh_cn/user_guides) help documentation.

## Result

### Quantitative Results
<div align=center><img src="https://github.com/CanZhang01/ASA/blob/main/Fig.4.png"/></div>
<div align=center><img src="https://github.com/CanZhang01/ASA/blob/main/Fig.5.png"/></div>
